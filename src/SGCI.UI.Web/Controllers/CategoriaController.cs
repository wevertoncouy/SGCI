...
namespace SGCI.UI.Web.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public CategoriaController(GestaoCarteiraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,Descriao")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,Descriao")] Categoria categoria)
        {
